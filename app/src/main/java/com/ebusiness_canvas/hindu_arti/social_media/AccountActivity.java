package com.ebusiness_canvas.hindu_arti.social_media;
...
//  private FloatingActionButton floatingActionButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState!=null){
            mUserId=savedInstanceState.getString(Contract.USER_ID);
            mUserEmailId=savedInstanceState.getString(Contract.USER_EMAIL);
            mUserDisplayName=savedInstanceState.getString(Contract.USER_DISPLAY_NAME);

            Log.i(TAG,"UserId:-"+mUserId);
            Log.i(TAG,"UserEmail:-"+mUserEmailId);
            Log.i(TAG,"UserDisplayName:-"+mUserDisplayName);
        }
    ...
    private void displayProfileInfo(Profile profile) {
        ...
        if (profile!=null){
            ...
            id.setText(mUserId);
            info.setText(mUserEmailId);
            Log.i(TAG,mUserDisplayName);
        }
    }
