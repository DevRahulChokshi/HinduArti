...
public class ContainerAdapter extends RecyclerView.Adapter<ContainerAdapter.MyViewHolder> {
    ...
    public ContainerAdapter(Context context, ArrayList<Category> mListData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=layoutInflater.inflate(R.layout.custom_nityakarma_layout,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mImageAvatar=itemView.findViewById(R.id.imageItem);
            mTextTitle=itemView.findViewById(R.id.txtItem);
            mTextID=itemView.findViewById(R.id.txtCompanyId);
        }
    }
}
